...
Tras haber iniciado la la sesión, se mostrará la pantalla del diario, en la cual, si no tienes ninguna nota registrada en la base de datos te mostrará un mensaje en la pantalla, que te indicará lo que tienes que hacer para crear una nota. 
Después de registrar la nota se te mostrará directamente en la pantalla, mostrando el mensaje escrito en la nota, la fecha del dia escrito y la hora en la que se escribió la nota.  
